 ...
 {{ csrf_field() }}
          <div class="input-group-btn search-panel">
              ...
              @foreach($listaCategorias as $lista)
                <li><a href="/cursocat/{{$lista->id}}">{{$lista->cat_nome}}</a></li>
              @endforeach
                <li class="divider"></li>
   ...
   <div class="container">
     ...
     @foreach($listaCursos as $lista)
        ...
        <div class="col-md-4 col-sm-6">
                  <div class="col-item">
                                ...
                                <a href="/detalhes/{{$lista->id}}">   <img src="http://localhost:/nossafrica/storage/app/public/{{$lista->curso_img}}" style="	max-width: 100%;	width: 360px; height: 260px; object-fit: cover;" alt="a" /></a>
                                </div>
                                <div class="info">
                                    <div class="row">
    ...
    @if(isset($cont))
     @if($cont=="")
            ...
            @if($cont=="PA")
            <p class="btn-details">
              <a href="/cursoestudante/{{$lista->id}}" class="btn col-12 btn-primary px-4 py-3 mt-3"> <i class="fa fa-eye"></i>Aceder</a></p>
          ...
          @endif
            <p class="btn-details">
                                           <a href="/detalhes/{{$lista->id}}" class="btn col-12 btn-primary px-4 py-3 mt-3"> <i class="fa fa-eye"></i> Descrição</a></p>
                                                            </div>
                                    <div class="clearfix">
                                    </div>
                                </div>
